...
| Параметр | Значение |
|---|---|
| gridLevels | только buy-уровни (sell-уровней всегда `GRID_SELL_LEVELS=20`, константа в `src/types.ts`) |
...
| `max orders` | buy/sell | достигнут `gridLevels + GRID_SELL_LEVELS + 4` |
